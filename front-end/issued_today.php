...
<html lang="en">
  ...
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@8"></script> 
    <title>Blockchain Based Certifiate Verification</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="view_certificate.php"><i class="app-menu__icon fa fa-cubes"></i><span class="app-menu__label">Today's Certificates</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1> All Certificates Issued Today:-</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    $date = date('Y-m-d');
                    $stmt = $conn->prepare("SELECT * FROM certificates WHERE SUBSTRING(createdAt, 1, 10) = '$date'");
                    $stmt->execute();
                    $result = $stmt->setFetchMode(PDO::FETCH_ASSOC);
                    foreach((new RecursiveArrayIterator($stmt->fetchAll())) as $k=>$v) { ?>
                    <tr>
                      <td><?php echo "$v[certificate_id]"; ?></td>
                      <td><?php echo "$v[staff_name]"; ?></td>
                      <td><?php echo "$v[staff_email]"; ?></td>
                      <td><?php echo "$v[batch_code]"; ?></td>
                      <td><?php echo "$v[training_title]"; ?></td>
                      <td><?php echo "$v[batch_trainer]"; ?></td>
                      <td><?php echo "$v[batch_duration]"; ?></td>
                      <td><?php echo "$v[certificate_location]"; ?></td>
                      <td><?php echo "$v[transaction_hash]"; ?></td>
                      <td><?php echo "$v[certificate_link]"; ?></td>
