  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="view_certificate.php"><i class="app-menu__icon fa fa-cubes"></i><span class="app-menu__label">View Certificates</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1> All Certificates Issued Till Date:-</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
